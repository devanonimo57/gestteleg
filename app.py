...
def generate_copy(persona, post_type, xai_key, used_texts=None):
    ...
    if post_type == "poll":
        ...
        prompt = (
            ...
            f"- Use 'corpinho' em vez de 'corpo'\n"
            f"- Adicione 1 emoji no FIM de algumas linhas, condizente com o que a linha fala (ex: linha sobre tesão → 🥵, sobre segredo → 😈, sobre molhada → 💦, sobre calor → 🔥)\n"
                ...
                "messages": [
                    ...
                    {"role": "user", "content": [
                        ...
                        {"type": "text", "text": (
                            ...
                            "- Use 'corpinho' em vez de 'corpo'\n"
                            "- Adicione 1 emoji no FIM de algumas linhas, condizente com o que a linha fala (ex: linha sobre tesão → 🥵, sobre segredo → 😈, sobre molhada → 💦, sobre calor → 🔥, sobre provocar → 😜)\n"
                            "- Termina com CTA contextual convidando pro VIP\n"
